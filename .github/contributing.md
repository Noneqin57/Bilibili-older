# 代码贡献指南
本项目是为了还原 2019 年 12 月 09 日[B站](https://www.bilibili.com/)逐渐弃用的播放页而来。原来只一个小小的用户脚本，后续随着代码规模增大，遂添加了chrome扩展支持。
...
#### 用户脚本
用户脚本模块位于/tampermonkey目录，主要是负责引导主模块，实际业务本体还是位于src目录。运行于脚本管理器提供的上下文，但基本不处理任何业务。  
